...
CREATE TABLE sites (
    ...
    status_app boolean,
    status_database boolean,
    status_monitoring boolean,
    status_dns boolean,
    status_domain boolean,
...
--
-- Name: index_sites_on_heroku_name; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_sites_on_heroku_name ON sites USING btree (heroku_name);
...
INSERT INTO schema_migrations (version) VALUES ('20140320112319');

INSERT INTO schema_migrations (version) VALUES ('20140320144645');

INSERT INTO schema_migrations (version) VALUES ('20140320181326');

INSERT INTO schema_migrations (version) VALUES ('20140322152317');

INSERT INTO schema_migrations (version) VALUES ('20140322153955');

INSERT INTO schema_migrations (version) VALUES ('20140328213335');

INSERT INTO schema_migrations (version) VALUES ('20140328220602');

INSERT INTO schema_migrations (version) VALUES ('20140518121347');

INSERT INTO schema_migrations (version) VALUES ('20140523091805');
